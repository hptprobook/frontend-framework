export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Hack Nasa with HTML & CSS Board',
    description: 'Bring HTML up to new high',
    type: 'public',
    ownerIds: [],
    memberIds: [],
    columnOrderIds: ['column-id-03', 'column-id-01', 'column-id-02'],
    columns: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        title: 'To Do Column 01',
        cardOrderIds: ['card-id-03', 'card-id-02', 'card-id-01', 'card-id-04', 'card-id-05', 'card-id-06', 'card-id-07'],
        cards: [
          {
            _id: 'card-id-01',
            boardId: 'board-id-01',
